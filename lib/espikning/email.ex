...
require EEx
  ...
  EEx.function_from_file(:defp, :welcome_email_body, @template_path, [:espikning, :eperson_exists, :handle])

  def welcome(espikning, eperson_exists, handle) do
    body = welcome_email_body(espikning, eperson_exists, handle)
    new()
